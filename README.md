...
Si se mantuviese durante un período de 10 años la inflación interanual de entorno el 6 por ciento que tenemos ahora a finales de 2023, implicaría inevitablemente que el capital líquido de la población va a reducirse a la mitad. Reitero: <strong>la población española tiene el potencial de perder la mitad de su dinero en 10 años</strong> (o lo que es lo mismo: si hoy 30 000 euros compran un coche, en 10 años se necesitarán 60 000 para comprar un producto con el mismo nivel de correspondencia en la gama del fabricante que hayamos escogido). Para demostrar esto en ejemplos del mundo real seguiré con el ejemplo de la automoción, tomando los datos reales de la base de datos de precios de kilómetro 77 vemos lo siguiente: un golf GTI -segmento C- costaba 32 850 € en el año 2013[^7] mientras que a día de hoy, en 2023, cuesta 45 985 €[^8] (un incremento del 40%); un citroen C3 -segmento B, más compacto- se podía comprar entonces desde 10 650 €[^9] mientras que ahora la misma cafetera cuesta 20 120 €[^10] (un 89% más); un Audi A3 sportback modelo base -también segmento C- costaba como mínimo 23 920 €[^11] y ahora cuesta 30 120€[^12] (26% más)... Y así en la comida, inmobiliario, servicios varios, etc. Los coches más baratos han aumentado más de precio porcentualmente que los coches más caros, imposibilitando a un gran proporción de la ciudadanía española el acceso a un coche nuevo en propiedad.
